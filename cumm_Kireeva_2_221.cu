...
int main(int argc, char* argv[])
{
    ...
    cudaMallocHost ((void**) &hostA, N*N * sizeof(double), cudaHostAllocDefault);
    cudaMallocHost ((void**) &hostB, N*N * sizeof(double), cudaHostAllocDefault);
    cudaMallocHost ((void**) &hostC, N*N * sizeof(double), cudaHostAllocDefault);
